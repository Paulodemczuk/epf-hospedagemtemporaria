...
class ReviewController(BaseController):
    ...
    def setup_routes(self):
        ...
        self.app.route('/stays/<stay_id:int>/reviews', method='GET',
                       callback=self.list_reviews_by_stay)

        self.app.route('/stays/<stay_id:int>/reviews/add',
                       method=['GET', 'POST'], callback=self.add_review)
        self.app.route('/reviews/edit/<review_id:int>',
                       method=['GET', 'POST'], callback=self.edit_review)
        self.app.route('/reviews/delete/<review_id:int>',
                       method='POST', callback=self.delete_review)
    ...
    def list_reviews_by_stay(self, stay_id):
        ...
        return self.render('stay_reviews', stay=stay, reviews=reviews)
